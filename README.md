...
If a fixture need to know the last loaded version, it must implement [LoadedFixtureVersionAwareInterface](src/Fixture/LoadedFixtureVersionAwareInterface.php) and `setLoadedVersion` method:
