...
use Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\Test1Bundle\Migrations\Schema\v1_0\Test1BundleMigration10;
use Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\Test1Bundle\Migrations\Schema\v1_1\Test1BundleMigration11;
use Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\WrongColumnNameMigration;
use Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\WrongTableNameMigration;
...
class MigrationExecutorWithNameGeneratorTest extends AbstractTestMigrationExecutor
{
    ...
    public function testWrongTableNameQuery()
    {
        ...
        $this->expectExceptionMessage(
            'Failed migrations: Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\WrongTableNameMigration.'
        );
        $this->executor->executeUp($migrations);
        $this->assertEquals(
            '> Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\WrongTableNameMigration',
    ...
    public function testWrongColumnNameQuery()
    {
        ...
        $this->expectException('\RuntimeException');
        $this->expectExceptionMessage(
            'Failed migrations: Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\WrongColumnNameMigration.'
        );
        $this->executor->executeUp($migrations);
        $this->assertEquals(
            '> Effiana\MigrationBundle\Tests\Unit\Fixture\TestPackage\WrongColumnNameMigration',
            $this->logger->getMessages()[0]
        );
        $this->assertEquals(
            sprintf(
