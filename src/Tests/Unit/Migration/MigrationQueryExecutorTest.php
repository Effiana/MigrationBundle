...
class MigrationQueryExecutorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecuteMigrationQuery()
    {
        $query = $this
            ->getMockForAbstractClass(
                'Effiana\MigrationBundle\Migration\MigrationQuery',
                [],
                '',
                true,
                true,
    ...
    {
        $query = $this->getMockBuilder('Effiana\MigrationBundle\Migration\ParametrizedMigrationQuery')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testExecuteMigrationQueryDryRun()
    {
        ...
        $query = $this->createMock('Effiana\MigrationBundle\Migration\MigrationQuery');
