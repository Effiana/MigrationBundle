...
use Effiana\MigrationBundle\Event\MigrationEvent;
...
class MigrationEventTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $middleMigration = $this->getMockForAbstractClass('Effiana\MigrationBundle\Migration\Migration');
        $this->migrationEvent->addMigration($middleMigration);
        $firstMigration = $this->getMockForAbstractClass('Effiana\MigrationBundle\Migration\Migration');
        $this->migrationEvent->addMigration($firstMigration, true);
        $lastMigration = $this->getMockForAbstractClass('Effiana\MigrationBundle\Migration\Migration');
