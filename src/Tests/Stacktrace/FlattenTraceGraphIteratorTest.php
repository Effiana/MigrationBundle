...
use Effiana\MigrationBundle\Stacktrace\FlattenTraceGraphIterator;
use Effiana\MigrationBundle\Stacktrace\Node;

/**
 * Class FlattenTraceGraphIteratorTest
 */
class FlattenTraceGraphIteratorTest extends PHPUnit\Framework\TestCase
{
