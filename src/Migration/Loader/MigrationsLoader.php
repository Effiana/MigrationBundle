...
use Effiana\MigrationBundle\Event\PostMigrationEvent;
...
class MigrationsLoader
{
    ...
    protected function getMigrationDirectories(): array
    {
        ...
        foreach ($bundles as $bundleName => $bundle) {
            ...
            $bundleMigrationDirectories = $this->getMigrationsPath($bundleMigrationPath);
        ...
        if($bundleMigrationDirectories !== null) {
            $result['App'] = $bundleMigrationDirectories;
        }
    ...
    protected function getMigrationsPath($bundleMigrationPath): ?array
    {
        if (is_dir($bundleMigrationPath)) {
            ...
            return $bundleMigrationDirectories;
        }
